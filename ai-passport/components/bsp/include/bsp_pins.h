...
// 每键的电压窗口 {min_mV, max_mV}; 增加 20mV 死区避开地线干扰与 DTR 瞬态毛刺
// 上键: ~0mV (20~140mV), 下键: ~300mV (180~430mV), 确定键: ~595mV (460~1200mV)
// 松开态: 3300mV (>1200mV 全部视为松开无按键)
#define BSP_BTN_MV_TABLE  { {20, 140}, {180, 430}, {460, 1200} }
