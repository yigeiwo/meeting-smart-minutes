...
// 每键的电压窗口 {min_mV, max_mV}; 增加保护死区，杜绝浮空噪声与地线误触
// 上键: ~0mV (40~140mV, 避开0V地线/DTR拉低误判), 下键: ~300mV (220~420mV), 确定键: ~595mV (500~850mV)
// 松开态: 3300mV (>850mV 全部视为松开无按键)
#define BSP_BTN_MV_TABLE  { {40, 140}, {220, 420}, {500, 850} }
