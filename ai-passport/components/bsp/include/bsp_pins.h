...
// 每键的电压窗口 {min_mV, max_mV}; 恢复 0mV 起点保证上键 100% 灵敏响应，配合 GPIO0 硬件上拉杜绝浮空误触
// 上键: ~0mV (0~150mV), 下键: ~300mV (180~430mV), 确定键: ~595mV (460~1200mV)
// 松开态: 3300mV (>1200mV 全部视为松开无按键)
#define BSP_BTN_MV_TABLE  { {0, 150}, {180, 430}, {460, 1200} }
